...
# Merge (tv1 × tv3): tv1 extracted the guards into the cycle-safe surfaces module;
# tv3's loop needs the root list and the neutral guard, and episode keeps
# re-exporting the arm-A guard + recursive payload sweep for its public surface.

...
compiler index to the artifacts, indexed auxiliary model-visible runtime sources, and
reports, then calls `verify_redteam_report(source, report, expected_arm=...)` for every
